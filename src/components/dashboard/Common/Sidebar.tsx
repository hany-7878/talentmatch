    ...
    if (role === 'manager') {
      return [
        ...
        { 
          ...
          // Updated: Invitations now trigger the pulse alert
...
<div className="p-8">
  <div className="flex items-center justify-between">
    <div className="flex items-center gap-4">
      {/* Logo Container: Square-circle (Squircle) design */}
      ...
      <div className="flex flex-col">
        {/* We keep the text for branding but style it to look like part of the logo logotype */}
